...
class AddDiskusiScreen extends StatefulWidget {
  @override
  _AddDiskusiScreenState createState() => _AddDiskusiScreenState();
}

class _AddDiskusiScreenState extends State<AddDiskusiScreen> {
  ...
  Future<File> cropImage(path) async {
    File croppedFile = await ImageCropper.cropImage(
      ...
      androidUiSettings: AndroidUiSettings(
        ...
        toolbarColor: Colors.purple[700],
  ...
  void submit() async {
    ...
    if (message == null) {
      ...
      if (userData != null) {
        Response response = await NetworkHelper().post('prs', {
          'title': title,
              ...
              children: [
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  width: 1,
                                  color: Colors.purple[700].withOpacity(.41),
                                ),
                              ),
                              child: Center(
                                child: Column(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        width: 1,
                                        color:
                                            Colors.purple[700].withOpacity(.41),
                                      ),
                                    ),
                                    child: Center(
                                      child: FaIcon(
                                        ...
                                        size: 16,
                                        color:
                                            Colors.purple[700].withOpacity(.9),
                                      ),
                                    ),
                                  ),
                                ),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                      width: 1,
                      color: Colors.purple[700].withOpacity(.68),
                    ),
                  ),
                  child: TextField(
